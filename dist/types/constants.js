...
exports.APP_CONSTANTS = exports.SOCKET_EVENTS = exports.NOTIFICATION_MESSAGES = void 0;
/**
...
exports.NOTIFICATION_MESSAGES = {
    ORDER: {
        ...
        STATUS_UPDATE: {
            TITLE: 'Order Update 🛵',
            BODY: (id, status) => `Your order #${id.substring(0, 6)} is now ${status.replace('_', ' ')}.`,
        },
        RIDER_AVAILABLE: {
    ...
    AUTH: {
        ...
        OTP_VERIFICATION: {
            ...
            BODY: (otp) => `Your Go-eat verification code is ${otp}. Do not share this with anyone.`,
        },
        PASSWORD_CHANGED: {
