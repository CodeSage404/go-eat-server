...
exports.resolveRequestLocation = resolveRequestLocation;
exports.buildCountryFilter = buildCountryFilter;
/**
...
function resolveRequestLocation(req) {
    ...
    const queryCountryCode = req.query.countryCode || req.query.regionCode;
    const headerCountry = req.headers['x-country'] || req.headers['x-region'];
    const headerCountryCode = req.headers['x-country-code'] || req.headers['x-region-code'];
    const user = req.user;
 ...
 */
function buildCountryFilter(country, countryCode) {
