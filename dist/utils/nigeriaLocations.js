...
exports.NIGERIA_STATES_DB = void 0;
exports.getStates = getStates;
exports.getLgasByState = getLgasByState;
exports.searchNigeriaLocations = searchNigeriaLocations;
exports.NIGERIA_STATES_DB = [
    {
        state: "Abia",
        alias: "abia",
        lgas: ["Arochukwu", "Bende", "Ikwuano", "Isiala Ngwa North", "Isiala Ngwa South", "Isuikwuato", "Obi Ngwa", "Ohafia", "Osisioma", "Ugwunagbo", "Ukwa East", "Ukwa West", "Umuahia North", "Umuahia South", "Umu Nneochi"]
    },
    {
        state: "Adamawa",
        alias: "adamawa",
        lgas: ["Demsa", "Fufure", "Ganye", "Gayuk", "Gombi", "Girei", "Hong", "Jada", "Lamurde", "Madagali", "Maiha", "Mayo Belwa", "Michika", "Mubi North", "Mubi South", "Numan", "Shelleng", "Song", "Toungo", "Yola North", "Yola South"]
    },
    {
        state: "Akwa Ibom",
        alias: "akwa_ibom",
    ...
    },
    {
        state: "Jigawa",
        alias: "jigawa",
        lgas: ["Auyo", "Babura", "Biriniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa", "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafur", "Kaugama", "Kazaure", "Kiri Kasama", "Kiyawa", "Maigatari", "Malam Madori", "Miga", "Ringim", "Roni", "Sule Tankarkar", "Taura", "Yankwashi"]
    },
    {
        state: "Kaduna",
        alias: "kaduna",
    ...
    },
    {
        state: "Katsina",
        alias: "katsina",
        lgas: ["Bakori", "Batagarawa", "Batsari", "Baure", "Bindawa", "Charanchi", "Dandume", "Danja", "Dan Musa", "Daura", "Dutsin Ma", "Faskari", "Funtua", "Ingawa", "Jibia", "Kafur", "Kaita", "Kankara", "Kankia", "Katsina", "Kurfi", "Kusada", "Mai'Adua", "Malumfashi", "Mani", "Mashi", "Musawa", "Rimi", "Sabuwa", "Safana", "Sandamu", "Zango"]
    },
    {
        state: "Kebbi",
        alias: "kebbi",
    ...
    },
    {
        state: "Lagos",
        alias: "lagos",
        lgas: ["Agege", "Ajeromi-Ifelodun", "Alimosho", "Amuwo-Odofin", "Apapa", "Badagry", "Epe", "Eti Osa", "Ibeju-Lekki", "Ifako-Ijaiye", "Ikeja", "Ikorodu", "Kosofe", "Lagos Island", "Lagos Mainland", "Mushin", "Ojo", "Oshodi-Isolo", "Somolu", "Surulere"]
    },
    {
        state: "Nasarawa",
        alias: "nasarawa",
    ...
    },
    {
        state: "Ondo",
        alias: "ondo",
        lgas: ["Akoko North-East", "Akoko North-West", "Akoko South-East", "Akoko South-West", "Akse", "Ese Odo", "Idanre", "Ifedore", "Ilahe", "Ilaje", "Ile Oluji/Okeigbo", "Irele", "Odigbo", "Okitipupa", "Ondo East", "Ondo West", "Ose", "Owo"]
    },
    {
        state: "Osun",
        alias: "osun",
...
function getStates() {
    return exports.NIGERIA_STATES_DB.map(s => s.state);
}
function getLgasByState(stateName) {
    const match = exports.NIGERIA_STATES_DB.find(s => s.state.toLowerCase() === stateName.toLowerCase());
    return match ? match.lgas : [];
}
function searchNigeriaLocations(query) {
    const q = query.toLowerCase().trim();
    const matches = [];
    for (const item of exports.NIGERIA_STATES_DB) {
        if (item.state.toLowerCase().includes(q)) {
            matches.push(`${item.state}, Nigeria`);
        }
        for (const lga of item.lgas) {
            if (lga.toLowerCase().includes(q)) {
                matches.push(`${lga}, ${item.state}, Nigeria`);
            }
        }
    }
