    ...
    async initializeTransporters() {
        ...
        try {
            ...
            if (process.env.NODE_ENV !== 'test') {
                ...
                logger_1.default.info(`📧 SMTP verified for info@goeatng.com`);
            }
        }
        catch (err) {
            logger_1.default.warn(`⚠️ info@goeatng.com SMTP failed: ${err.message}. Enabling mock Ethereal fallback.`);
        ...
        try {
            ...
            if (process.env.NODE_ENV !== 'test') {
                ...
                logger_1.default.info(`📧 SMTP verified for partners@goeatng.com`);
            }
        }
        catch (err) {
            logger_1.default.warn(`⚠️ partners@goeatng.com SMTP failed: ${err.message}. Enabling mock Ethereal fallback.`);
        ...
        try {
            ...
            if (process.env.NODE_ENV !== 'test') {
                ...
                logger_1.default.info(`📧 SMTP verified for secure@goeatng.com`);
            }
        }
        catch (err) {
            logger_1.default.warn(`⚠️ secure@goeatng.com SMTP failed: ${err.message}. Enabling mock Ethereal fallback.`);
