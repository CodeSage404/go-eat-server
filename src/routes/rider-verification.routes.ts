...
import riderVerificationController from '../controllers/rider-verification.controller';
 ...
 */
router.get('/verification', riderVerificationController.getRiderVerification);
 ...
 */
router.post('/verification/submit', riderVerificationController.submitRiderVerification);
 ...
 *         description: Unauthorized
 */
router.post('/verification/skip', riderVerificationController.skipOnboarding);
...
router.get(
  ...
  riderVerificationController.adminListRiderVerifications
);
...
router.get(
  ...
  restrictTo(UserRole.ADMIN),
  riderVerificationController.adminGetRiderVerificationDetails
);
...
router.patch(
  ...
  restrictTo(UserRole.ADMIN),
  riderVerificationController.adminApproveRider
);
...
router.patch(
  ...
  restrictTo(UserRole.ADMIN),
  riderVerificationController.adminRejectRider
);
