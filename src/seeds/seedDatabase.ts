...
const seedRestaurants: SeedRestaurantDef[] = [
  // ===================== NIGERIAN OUTLETS =====================
  {
    data: {
  ...
  // ===================== UK OUTLETS (LONDON) =====================
  {
    data: {
      ...
      location: {
        type: 'Point' as const,
        coordinates: [-0.1585, 51.5207] as [number, number],
      },
      country: 'United Kingdom',
      countryCode: 'GB',
      isUk: true,
  ...
  },
  {
    data: {
      ...
      location: {
        type: 'Point' as const,
        coordinates: [-0.1276, 51.5126] as [number, number],
      },
      country: 'United Kingdom',
      countryCode: 'GB',
      isUk: true,
  ...
  },
  {
    data: {
      ...
      location: {
        type: 'Point' as const,
        coordinates: [-0.1374, 51.5135] as [number, number],
      },
      country: 'United Kingdom',
      countryCode: 'GB',
      isUk: true,
  ...
  // ===================== ITALIAN OUTLETS (ROME) =====================
  {
    data: {
      ...
      location: {
        type: 'Point' as const,
        coordinates: [12.4776, 41.8872] as [number, number],
      },
      country: 'Italy',
      countryCode: 'IT',
      isItaly: true,
  ...
  },
  {
    data: {
      ...
      location: {
        type: 'Point' as const,
        coordinates: [12.4930, 41.9004] as [number, number],
      },
      country: 'Italy',
      countryCode: 'IT',
      isItaly: true,
...
async function seed() {
  try {
    ...
    await Restaurant.updateMany(
      ...
      { $set: { country: 'Nigeria', countryCode: 'NG', isNigeria: true, isUk: false, isItaly: false } }
    );
    await Restaurant.updateMany(
      { $or: [{ 'address.country': { $exists: false } }, { 'address.country': null }] },
      { $set: { 'address.country': 'Nigeria', 'address.countryCode': 'NG' } }
    );
